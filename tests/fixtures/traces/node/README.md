...
Real, unedited tool output. Regenerate with `python scripts/capture_trace_fixtures.py --only node`.
...
|---|---|---|
| `01-type-error.txt` | node | `node /src/programs/node/type_error.js` |
| `02-custom-error.txt` | node | `node /src/programs/node/custom_error.js` |
| `03-unhandled-rejection.txt` | node | `node /src/programs/node/unhandled_rejection.js` |
