...
Real, unedited tool output. Regenerate with `python scripts/capture_trace_fixtures.py --only java`.
...
|---|---|---|
| `01-null-pointer.txt` | java (single-file source launch) | `java /src/programs/java/NullField.java` |
| `02-array-index.txt` | java (single-file source launch) | `java /src/programs/java/IndexOutOfBounds.java` |
| `03-caused-by.txt` | java (single-file source launch) | `java /src/programs/java/CausedBy.java` |
