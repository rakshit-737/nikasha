...
Real, unedited tool output. Regenerate with `python scripts/capture_trace_fixtures.py --only rust`.
...
|---|---|---|
| `01-index-oob-backtrace.txt` | rustc -g, RUST_BACKTRACE=1 | `rustc -g -o /work/prog /src/programs/rust/index_oob.rs && RUST_BACKTRACE=1 /work/prog` |
| `02-unwrap-none-backtrace-full.txt` | rustc -g, RUST_BACKTRACE=full | `rustc -g -o /work/prog /src/programs/rust/unwrap_none.rs && RUST_BACKTRACE=full /work/prog` |
| `03-thread-panic.txt` | rustc -g, RUST_BACKTRACE=1 | `rustc -g -o /work/prog /src/programs/rust/thread_panic.rs && RUST_BACKTRACE=1 /work/prog` |
