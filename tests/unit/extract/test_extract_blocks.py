...
class TestPatches:
    def test_unidiff_parses_and_restores_blank_context(self):
        files, hunks = parse_with_unidiff(GOOD_PATCH)
...
class TestSnippets:
    ...
    def test_unattributed_snippet_is_unscoped(self):
    ...
    def test_definition_forms(self, code, names):
