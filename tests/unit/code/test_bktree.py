...
def test_name_parts_linear_on_long_input() -> None:
...
def test_duplicates_keep_every_original_spelling() -> None:
...
def test_suggest_ranks_by_distance_then_jaccard_then_word() -> None:
...
def test_suggest_jaccard_tiebreak() -> None:
...
def test_suggest_word_tiebreak_is_deterministic() -> None:
...
def test_suggest_radius_is_quarter_length_at_least_one() -> None:
...
def test_vulnlab_fabricated_name_has_no_suggestion() -> None:
