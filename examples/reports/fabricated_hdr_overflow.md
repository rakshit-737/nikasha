...
this is not a report about real software. Every detail below is deliberately wrong (SPEC.md Appendix B). Expected verdict:
UNGROUNDED, with 5 or more refuting evidence items across 3 or more groups.
-->
